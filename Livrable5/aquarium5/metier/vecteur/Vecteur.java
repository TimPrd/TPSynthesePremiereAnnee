package aquarium5.metier.vecteur;
...
public class Vecteur implements IPosition
{
	 ...
	 *
	 * @param lambda facteur de multiplication
	...
	/**
	 *
	 * @param v le vecteur position du poisson à fuir
	 * @return fait le produit scalaire des vecteurs position des deux poissons
     */
	 ...
	 *
	 * @param v le vecteur position du poisson à fuir
	 * @return l'arcCos de l'angle du produit scalaire divisé par le produit des deux longueurs
     */
	public double angle(Vecteur v)
	{
		return Math.acos(produitScalaire(v) / (v.getNorme() * this.getNorme()));
	}
